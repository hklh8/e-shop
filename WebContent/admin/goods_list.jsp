...
<body>
	<div class="container">
		...
		<div id="admin_right">
			<div class="headbar">
				<div class="searchbar">
					<form action="goods_listByPage" method="get" id="form1">
						...
						</select> 商品名： <input class="small" name="goods.name" id="name" type="text" value="">
			...
			--%>
			<a href='javascript:goPage(${pageBean.totalPage})' id="last" >尾页</a><span>当前第${pageBean.page}页/共${pageBean.totalPage}页</span></div>
		</div>
