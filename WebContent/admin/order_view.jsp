				...
				<div class="content">
					<table class="list_table">
						...
						<c:forEach items="${order.orderDetails}" var="orderDetail">
							<tr>
								...
								<td>${orderDetail.goods.price2}</td>
								<td>${orderDetail.nums}</td>
								<td>${orderDetail.goods.price2*orderDetail.nums}</td>
							</tr>
						</c:forEach>
						</tbody>
					</table>
					...
					<table style="width:300px;margin-right:20px;"
						...
						<tbody>
							...
							<tr>
								<th>地区:</th>
								<td>${order.address.province}&nbsp;${order.address.city}&nbsp;${order.address.area}</td>
							</tr>
							<tr>
								<th>地址:</th>
